...
# Useful variables
SECURE_FILE_LIST=("model.py" "feature.py" "hyper_param.json") # Fill this based on the assignment
DELETE_FILE_LIST=("submit.sh" "regularized_logistic_regression.ipynb" "train" "hint.pdf" "utils.py") # Fill this list based on the assignment
ROLL_NO=$1
ASSIGNMENT_NO=3 # Fill this based on the assignment
