...
# Useful variables
SECURE_FILE_LIST=("model.py" "model_nn.pkl") # Fill this based on the assignment
DELETE_FILE_LIST=("__pycache__" "submit.sh" "grad_check.py" "main.py" "hint.pdf" "utils.py" "train_X.npy" "train_Y.npy" "val_X.npy" "val_Y.npy" "README" "test.py") # Fill this list based on the assignment
ROLL_NO=$1
ASSIGNMENT_NO=8 # Fill this based on the assignment
