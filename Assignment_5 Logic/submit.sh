...
# Useful variables
SECURE_FILE_LIST=("knowledge.py" "logic.py") # Fill this based on the assignment
DELETE_FILE_LIST=("submit.sh" "test.py" "utils.py") # Fill this list based on the assignment
ROLL_NO=$1
ASSIGNMENT_NO=5 # Fill this based on the assignment
