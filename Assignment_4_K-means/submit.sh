...
# Useful variables
SECURE_FILE_LIST=("model.py" "feature.py" "submission.pickle") # Fill this based on the assignment
DELETE_FILE_LIST=("submit.sh" "kmeans.ipynb" "joined" "test.ipynb" "2.pickle") # Fill this list based on the assignment
ROLL_NO=$1
ASSIGNMENT_NO=4 # Fill this based on the assignment
